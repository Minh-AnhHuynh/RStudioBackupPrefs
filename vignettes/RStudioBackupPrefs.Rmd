...
The function will pull from github by default, and will to **copy the files** to
the rstudio preference folder (import).
...
### Your files are in a different R Project/Git folder and you want to do a git pull
...
``` r
start_import_prefs(pull_github = FALSE, "R/rstudio_preferences/")
```
